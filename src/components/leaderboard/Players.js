...
export default function Players() {
  ...
  return (
    <div>
      <div id="options">
        ...
        >
          <Dropdown>
            ...
            <Dropdown.Menu>
              <Dropdown.Item onClick={() => setSortBy("Playoff Points")}>
                Playoff Points
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setSortBy("Playoff Assists")}>
                Playoff Assists
              </Dropdown.Item>
              <Dropdown.Divider />
              <Dropdown.Item onClick={() => setSortBy("Total Points")}>
                Total Points
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setSortBy("Total Assists")}>
                Total Assists
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setSortBy("Total Rebounds")}>
                Total Rebounds
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
      ...
      <div id="data">
        <h2>
          {sortBy} Top Players for Season {season}
        </h2>
        <hr />
        {playerData.length > 0 ? (
          <PlayerTable />
